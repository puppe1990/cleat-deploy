defmodule CleatDeployWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: CleatDeployWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CleatDeployWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CleatDeployWeb.Gettext, "errors", msg, opts)
    end
  end
