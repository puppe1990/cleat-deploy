defmodule CleatDeploy.Deploy.DnsTest do
  use ExUnit.Case, async: false

  alias CleatDeploy.Deploy.Dns
  ...
  test "first_ipv4/1 returns the first A record from the resolver" do
    ...
    Mox.expect(CleatDeploy.Deploy.DnsMock, :lookup_a, fn "app.gestaobem.com" ->
  ...
  test "first_ipv4/1 returns error when resolver has no A record" do
    ...
    Mox.expect(CleatDeploy.Deploy.DnsMock, :lookup_a, fn "missing.example" ->
      {:error, :no_a_record}
    end)
